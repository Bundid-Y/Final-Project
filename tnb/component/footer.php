...
<footer class="footer-custom">
    <div class="footer-container">
        ...
        <div class="footer-col footer-brand">
            ...
            <ul class="footer-contact">
                <li>
                    ...
                    <span data-i18n="contact.address">18/2 หมู่ที่ 5 ตำบลเหมือง อำเภอเมืองชลบุรี จังหวัดชลบุรี
                        20130</span>
                </li>
                <li>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <li>
                    ...
                    <span>wachira.o@tnb-logistics.com</span>
                </li>
            </ul>
        </div>
        ...
        <div class="footer-col">
            ...
            <ul class="footer-links">
                ...
                <li><a href="../main/partners.php" data-i18n="footer.services">บริการ</a></li>
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-container">
            <p>&copy; <?php echo date("Y"); ?> TNB Logistics Co.,Ltd. All Rights Reserved.</p>
        </div>
    </div>
</footer>
<!-- /footer -->
